...
class LeafDataset(Dataset):
    """
    REAL_ONLY配置 (3分类: Background/Healthy/Disease)
    Disease类别只用Real_disease，Proxy_disease完全不参与训练。
    """
